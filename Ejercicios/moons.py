...
nn = [2, 20, 15, 10, 6, 5, 4, 4, 1]  # número de neuronas por capa.
...
# Última capa
output_layer = create_layer(current_layer, nn[-2], nn[-1], activations[-1])
...
n_steps = 8500  # Número de ciclos de entrenamiento.
